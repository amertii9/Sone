(function (global, factory) {
  ...
  function injectasset(url, waitFor, callback) {
    if (isNil(url)) {
      console.error('Inject asset error');
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectasset(this.settings.plyr.css, 'Plyr');
    var url = data.href;
    var provider = data === null || data === void 0 ? void 0 : data.videoProvider;
    var customPlaceholder = false;
    slideMedia.style.maxWidth = data.width;
    injectasset(this.settings.plyr.js, 'Plyr', function () {
